    ...
    <div className="space-y-6" style={{ fontFamily: "var(--font-outfit), sans-serif" }}>
      <div className="print:hidden">
        <div className="mb-4">
          <Breadcrumb
            items={[
              ...
              { label: "Purchase History", href: "/dashboard/admin/purchases" },
        ...
        <div className="flex justify-between items-center bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-gray-100 shadow-sm mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Purchase Returns</h1>
            <p className="text-sm text-gray-500">Track and manage debit notes &amp; reversed purchase entries</p>
          </div>
          <div>
            <Button
