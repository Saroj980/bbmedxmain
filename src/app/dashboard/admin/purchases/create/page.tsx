...
import PurchaseItemsSection from "@/components/purchases/PurchaseItemSection";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border rounded-xl shadow-sm p-6 space-y-6">
        ...
        <div className="flex items-center justify-between pb-4 border-b">
          <h3 className="text-xl font-bold text-gray-800">New Purchase</h3>
        </div>
        ...
        <div className="pt-6 mt-6 border-t flex justify-end gap-3">
          ...
          <Button
            className="bg-[#009966] text-white px-8"
