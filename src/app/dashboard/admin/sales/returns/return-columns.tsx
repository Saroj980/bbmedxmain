...
export const returnColumns = (
  ...
  return [
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <span className="text-sm font-semibold text-emerald-600 hover:underline cursor-pointer" onClick={() => router.push(`/dashboard/admin/sales/${row.original.sale_id}`)}>
          {row.original.sale?.invoice_no}
        </span>
      ),
    },
    {
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  onClick={() => router.push(`/dashboard/admin/sales/${row.original.sale_id}`)}
